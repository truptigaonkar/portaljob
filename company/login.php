  ...
  <div class="login-box-body">
    ...
    ?>      
      ...
      <div class="form-group has-feedback">
        <input type="email" class="form-control" id="companyemail" name="companyemail" placeholder="Company Email" required="">
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="password" class="form-control" id="companypassword" name="companypassword" placeholder="companypassword" required="">
        <span class="glyphicon glyphicon-lock form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <button type="submit" class="btn btn-primary btn-block btn-flat">Company Sign In</button>
        <p class="text-center"><a href="register.php" class="text-center">Company Register if no account</a></p>
      </div>
    </form>
